...
$mysqli->query("UPDATE usertable SET bebename='$nombrebebe',padrenombre='$nombre',padreapellido='$apellido',telefonocasa='$telcasa',telefonocelular='$telcel',nhc='$clavenhc' WHERE email='$email'");
