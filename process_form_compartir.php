...
$mysqli->query("UPDATE usertable SET bebename='$nombrebebe',padrenombre='$nombre',padreapellido='$apellido',telefonocasa='$telcasa',telefonocelular='$telcel',nhc='$clavenhc',email='$email',pic1='$archivoruta1',pic2='$pic2ruta',pic3='$pic3ruta',pic4='$pic4ruta',pic5='$pic5ruta' WHERE email='$email'");
