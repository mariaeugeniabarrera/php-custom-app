 ...
 */
$aColumns = array( 'id', 'fbid', 'padrenombre', 'padreapellido','bebename', 'telefonocasa', 'telefonocelular', 'email', 'nhc','pic1' );
...
$gaSql['user']     = 'xtrategi_ingenes';
$gaSql['password'] = 'D62q,s@%4;lOeuAl{i';
$gaSql['db']       = 'xtrategi_ingenesbebe2';
