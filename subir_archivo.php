...
if (isset($_FILES['archivo'])) {
    ...
    $nombre = "{$_POST['nombre_archivo']}$time.$extension";
		$sizearchivo = $_FILES['archivo']['size'];

if (($extension=='jpeg' || $extension=='jpe' || $extension=='jpg' || $extension=='png' || $extension=='gif' ) && ($sizearchivo<=10000000000))
{


if (move_uploaded_file($archivo['tmp_name'], "pictures/$nombre")) {
