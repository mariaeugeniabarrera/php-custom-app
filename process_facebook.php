...
echo '
<p class="green"> Hola! de Nuevo... '.$me['name'].'</p>
...
';
		...
		login_user(true,$me['first_name'].' '.$me['last_name'], $me['email'],$me['first_name'],$me['last_name'],$uid);
	}
   ...
   // Primer inicio de sesión
	 //echo '<a href="subirimagenes.php">subirimagenes</a>';




echo '
<p class="green">'.$me['name'].'</p>
...
function login_user($loggedin,$user_name,$email,$first_name,$last_name,$facebookiduser)
{
	/*
	...
	*/
	...
	$_SESSION['facebookiduser']=$facebookiduser;
